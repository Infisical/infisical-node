...
var InfisicalClient = /** @class */ (function () {
     ...
     */
    function InfisicalClient(options) {
        if (options === void 0) { options = {
            token: undefined,
            siteURL: variables_1.INFISICAL_URL,
            debug: false,
            cacheTTL: 300
        }; }
        this.cache = {};
        ...
        this.debug = false;
        var token = options.token, siteURL = options.siteURL, debug = options.debug, cacheTTL = options.cacheTTL;
        if (token && token !== '') {
    ...
    */
    InfisicalClient.prototype.getAllSecrets = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, client_1.getAllSecretsHelper)(this)];
