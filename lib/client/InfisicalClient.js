...
var InfisicalClient = /** @class */ (function () {
    ...
    InfisicalClient.connect = function (_a) {
        var token = _a.token, _b = _a.siteURL, siteURL = _b === void 0 ? variables_1.INFISICAL_URL : _b, _c = _a.attachToProcessEnv, attachToProcessEnv = _c === void 0 ? false : _c, _d = _a.defaultValues, defaultValues = _d === void 0 ? {} : _d;
     ...
     * @returns {Promise<Infisical>} - A promise that resolves with a new instance of `Infisical`.
     */
    InfisicalClient.createConnection = function (_a) {
        var token = _a.token, _b = _a.siteURL, siteURL = _b === void 0 ? variables_1.INFISICAL_URL : _b, _c = _a.defaultValues, defaultValues = _c === void 0 ? {} : _c;
        return __awaiter(this, void 0, void 0, function () {
            var instance;
    ...
    InfisicalClient.prototype.setup = function (_a) {
        var _b = _a.attachToProcessEnv, attachToProcessEnv = _b === void 0 ? false : _b, _c = _a.defaultValues, defaultValues = _c === void 0 ? {} : _c;
        return __awaiter(this, void 0, void 0, function () {
            var serviceTokenData, encryptedSecrets, workspaceKey, secrets_1, err_1;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        secrets_1 = services_1.KeyService.decryptSecrets({
                        ...
                        if (attachToProcessEnv) {
                            ...
                            Object.keys(defaultValues).map(function (defaultKey) {
                                _this.secrets[defaultKey] = defaultValues[defaultKey];
                                process.env[defaultKey] = defaultValues[defaultKey];
                            });
                            Object.keys(secrets_1).map(function (key) {
                                _this.secrets[key] = secrets_1[key];
                                process.env[key] = secrets_1[key];
                            });
                        }
                        else {
     ...
     */
    InfisicalClient.prototype.getSecretValue = function (key) {
        var _a;
        var value;
     ...
     * @returns {String} value - value of secret
     */
    InfisicalClient.getSecretValue = function (key) {
        var value;
