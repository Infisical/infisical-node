 ...
 */
declare const encryptAsymmetric: ({ plaintext, publicKey, privateKey }: {
    plaintext: string;
    publicKey: string;
    privateKey: string;
}) => {
 ...
 */
declare const decryptAsymmetric: ({ ciphertext, nonce, publicKey, privateKey }: {
    ciphertext: string;
    nonce: string;
    publicKey: string;
    privateKey: string;
 ...
 */
declare const encryptSymmetric: ({ plaintext, key }: {
    plaintext: string;
    key: string;
}) => {
    ciphertext: string;
 ...
 *
 */
declare const decryptSymmetric: ({ ciphertext, iv, tag, key }: {
    ciphertext: string;
    iv: string;
    tag: string;
    key: string;
