...
var getDecryptedSecretsHelper = function (_a) {
    var apiRequest = _a.apiRequest, workspaceId = _a.workspaceId, environment = _a.environment, workspaceKey = _a.workspaceKey;
    return __awaiter(void 0, void 0, void 0, function () {
        var secrets;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, secrets.map(function (secret) {
                            var secretName = (0, crypto_1.decryptSymmetric)({
                                ciphertext: secret.secretKeyCiphertext,
                                iv: secret.secretKeyIV,
                                tag: secret.secretKeyTag,
                                key: workspaceKey
                            });
                            var secretValue = (0, crypto_1.decryptSymmetric)({
...
var getDecryptedSecretHelper = function (_a) {
    var apiRequest = _a.apiRequest, secretName = _a.secretName, workspaceId = _a.workspaceId, environment = _a.environment, workspaceKey = _a.workspaceKey, type = _a.type;
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    secret = _b.sent();
                    secretValue = (0, crypto_1.decryptSymmetric)({
                        ciphertext: secret.secretValueCiphertext,
                        iv: secret.secretValueIV,
                        tag: secret.secretValueTag,
                        key: workspaceKey
...
var createSecretHelper = function (_a) {
    var apiRequest = _a.apiRequest, workspaceKey = _a.workspaceKey, workspaceId = _a.workspaceId, environment = _a.environment, type = _a.type, secretName = _a.secretName, secretValue = _a.secretValue;
    return __awaiter(void 0, void 0, void 0, function () {
        var _b, secretKeyCiphertext, secretKeyIV, secretKeyTag, _c, secretValueCiphertext, secretValueIV, secretValueTag, secret;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _b = (0, crypto_1.encryptSymmetric)({
                        plaintext: secretName,
                        key: workspaceKey
                    }), secretKeyCiphertext = _b.ciphertext, secretKeyIV = _b.iv, secretKeyTag = _b.tag;
                    _c = (0, crypto_1.encryptSymmetric)({
