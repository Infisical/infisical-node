...
var expandSecrets_1 = require("./expandSecrets");
/**
...
var getDecryptedSecretsHelper = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var content, _b, secrets, imports, importedSecrets, _i, imports_1, singleImport, _c, _d, secret, secretName, secretValue, transformedSecret, topLevelSecrets, hasOverridden, _e, topLevelSecrets_1, sec, i, importedSecret, expandedSecrets, secretValues;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, expandSecrets_1.expandSecrets)(workspaceId.toString(), workspaceKey, apiRequest, environment, path, content, includeImports)];
                case 2:
                    expandedSecrets = _f.sent();
                    secretValues = Object.values(expandedSecrets).map(function (secret) { return secret.value; });
                    // console.log("secretValues:", secretValues);
                    topLevelSecrets = topLevelSecrets.map(function (bundle, index) { return (__assign(__assign({}, bundle), { secretValue: secretValues[index] })); });
...
var getDecryptedSecretHelper = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var content, secret, secretValue, expandedSecret, expandedSecretValue;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    content = {};
                    return [4 /*yield*/, (0, api_1.getSecret)(apiRequest, {
                            secretName: secretName,
                            workspaceId: workspaceId,
                            environment: environment,
                            type: type,
                ...
                case 1:
                    ...
                    content[secretName] = { value: secretValue };
                    return [4 /*yield*/, (0, expandSecrets_1.expandSecrets)(workspaceId.toString(), workspaceKey, apiRequest, environment, path, __assign({}, content))];
                case 2:
                    expandedSecret = _b.sent();
                    expandedSecretValue = expandedSecret.value;
