...
var fetchSecretsCrossEnv = function (_a) {
    ...
    return function (secRefEnv, secRefPath, secRefKey) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    secRefPathUrl = path_1.default.join.apply(path_1.default, __spreadArray(["/"], secRefPath, false));
...
var recursivelyExpandSecret = function (expandedSec, interpolatedSec, fetchCrossEnv, recursionChainBreaker, key) { return __awaiter(void 0, void 0, void 0, function () {
    var interpolatedValue, refs, resolvedValues, _i, refs_1, interpolationSyntax, interpolationKey, val;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!refs) return [3 /*break*/, 5];
                resolvedValues = [];
                _i = 0, refs_1 = refs;
                _a.label = 1;
            case 1:
                if (!(_i < refs_1.length)) return [3 /*break*/, 4];
                interpolationSyntax = refs_1[_i];
                interpolationKey = interpolationSyntax.slice(2, -1);
