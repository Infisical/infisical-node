...
function getSecretHelper(instance, secretName, options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var cacheKey, cachedSecret, _c, currentTime, cacheExpiryTime, secretBundle, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    _c = instance.clientConfig;
                    return [4 /*yield*/, services_1.SecretService.populateClientWorkspaceConfig(instance.clientConfig)];
                case 2:
                    _c.workspaceConfig = _d.sent();
                    _d.label = 3;
                case 3:
                    cachedSecret = instance.cacheConfig.cache.get(cacheKey);
                    if (cachedSecret) {
                    ...
                    return [4 /*yield*/, services_1.SecretService.getDecryptedSecret({
                            ...
                            environment: (_b = instance.clientConfig.workspaceConfig) === null || _b === void 0 ? void 0 : _b.environment,
                            type: options.type
                        })];
                case 4:
                    secretBundle = _d.sent();
                    instance.cacheConfig.cache.set(cacheKey, secretBundle);
...
function getAllSecretsHelper(instance) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, secretBundles, err_2;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 4, , 6]);
...
function createSecretHelper(instance, secretName, secretValue, options) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, secretBundle, cacheKey, err_3;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 4, , 6]);
...
function updateSecretHelper(instance, secretName, secretValue, options) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, secretBundle, cacheKey, err_4;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 4, , 6]);
...
function deleteSecretHelper(instance, secretName, options) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var _c, secretBundle, cacheKey, err_5;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 4, , 6]);
