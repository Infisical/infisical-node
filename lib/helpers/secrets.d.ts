 ...
 */
export declare const getDecryptedSecretsHelper: ({ apiRequest, workspaceId, environment, workspaceKey }: GetDecryptedSecretsParams) => Promise<ISecretBundle[]>;
/**
 * Get a (decrypted) secret
 * @param {GetDecryptedSecretParams} getDecryptedSecretParams
 * @returns
 */
export declare const getDecryptedSecretHelper: ({ apiRequest, secretName, workspaceId, environment, workspaceKey, type }: GetDecryptedSecretParams) => Promise<ISecretBundle>;
/**
 * Create a secret
 * @param {CreateSecretParams} createSecretParams
 * @returns
 */
export declare const createSecretHelper: ({ apiRequest, workspaceKey, workspaceId, environment, type, secretName, secretValue }: CreateSecretParams) => Promise<ISecretBundle>;
/**
 * Update a secret
 * @param {UpdateSecretParams} updateSecretParams
 * @returns
 */
export declare const updateSecretHelper: ({ apiRequest, workspaceKey, workspaceId, environment, type, secretName, secretValue }: UpdateSecretParams) => Promise<ISecretBundle>;
/**
 * Delete a secret
